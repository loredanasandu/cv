...
\usepackage{geometry}
\geometry{left=1.75cm, top=1.25cm, right=1.75cm, bottom=1.25cm, footskip=.5cm}
...
\titlespacing*{\section}
{0pt}{2.75ex plus 1ex minus .2ex}{2.25ex plus .2ex}
...
\begin{center}
    ...
    \href{mailto:loredana-sandu@uoc.edu}{\faEnvelope \ \graydotuline{loredana-sandu@uoc.edu}} \, $|$ \, % row = 2, col = 1
    %\href{mailto:sandu.loredana@outlook.com}{\faEnvelope \, \graydotuline{sandu.loredana@outlook.com}} \, $|$ \, % row = 2, col = 1
    \faHome \ Mollet del Vallès (Barcelona) \\[1.5pc] % row = 2, col = 1
\end{center}
%-------------------------------------------
...
\section{Selected Reports, Talks and Projects}
  ...
  \begin{itemize}[leftmargin=3em, itemsep=0.1em, topsep=2pt]
    ...
    \item \small Advised by \href{https://ufind.univie.ac.at/en/person.html?id=110430}{\graydotuline{Dr. Himani Sachdeva}} and \href{https://ufind.univie.ac.at/en/person.html?id=59719/}{\graydotuline{Dr. Jitka Polechová}}.
  \end{itemize}
  \resumeHeadingListEnd{}
  ...
  \resumeHeadingListStart{}
    ...
    \begin{itemize}[leftmargin=3em, itemsep=0.1em, topsep=2pt]
      ...
      \item \small Advised by \href{https://ufind.univie.ac.at/en/person.html?id=33917}{\graydotuline{Prof. Joachim Hermisson}}.
    \end{itemize}
  \resumeItemListEnd{}
  ...
  \resumeHeadingListStart{}
    ...
    \begin{itemize}[leftmargin=3em, itemsep=0.1em, topsep=2pt]
      ...
      \item \small Advised by \href{https://mat.uab.cat/departament/uab/pop_ex.php?id=172&lang=cat}{\graydotuline{Prof. Julià Cufí}} and \href{https://mat.uab.cat/departament/uab/pop_ex.php?id=208&lang=}{\graydotuline{Dr. Xavier Mora}}.
    \end{itemize}
  \resumeHeadingListEnd{}
  ...
  \resumeHeadingListStart{}
    ...
    \begin{itemize}[leftmargin=3em, itemsep=0.1em, topsep=2pt]
      ...
      \item \small Advised by \href{https://mat.uab.cat/geoarit/index.php/people?controller=member&view=member&id=1}{\graydotuline{Dr. Joaquim Roé}}.
    \end{itemize}
  \resumeItemListEnd{}
